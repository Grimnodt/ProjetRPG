...
public class ReponsesQuiz implements Parcelable {
    ...
    // Clé unique pour passer cet objet dans un Intent
    public static final String KEY = "SAC_DE_REPONSES";

    // Un champ pour chaque réponse de votre quiz
    private int reponseQ1;
    private int reponseQ2;
    private int reponseQ3;
    private ArrayList<Integer> reponseQ4;
    private boolean reponseMajeur; // Page 3 Switch
    private String reponseQ5;      // Page 3 Spinner
    private int reponseQ7;         // Page 3 RadioGroup (Prophétie)
    private int reponseQ8;         // Page 4 RadioGroup (Demon Slayer)
    private boolean reponseQ9;      // Page 4 Switch (Confirmation)
    private int reponseQ10;        // Page 5 RadioGroup (Artefact)
    private int reponseQ11;        // Page 5 RadioGroup (Paysage)
